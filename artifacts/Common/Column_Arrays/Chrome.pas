...
const
  ...
  // DO NOT USE RESERVED NAMES IN FEX_COL LIKE 'NAME', 'ID'
    ...
    Array_Items_Chrome_Autofill: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Autofill_Profiles: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Bookmarks: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Cache: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Cookies: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Downloads: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Favicons: TSQL_Table_array = (
    //(sql_col: 'DNT_id';                          fex_col: 'ID Col';                     read_as: ftString;             convert_as: '';                col_type: ftString;      show: True),
    ...
    Array_Items_Chrome_History: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Keyword_Search_Terms: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Logins: TSQL_Table_array = (
    ...
    Array_Items_Chrome_Shortcuts: TSQL_Table_array = (
    //(sql_col: 'DNT_id';                          fex_col:  'ID Col';                    read_as: ftString;             convert_as: '';                col_type: ftString;      show: True),
    ...
    Array_Items_Chrome_SyncData: TSQL_Table_array = (
    ...
    Array_Items_Chrome_TopSites: TSQL_Table_array = (
...
begin
  if Name = 'CHROMEAUTOFILL'           then Result := Array_Items_Chrome_Autofill else
  if Name = 'CHROMEAUTOFILLPROFILES'   then Result := Array_Items_Chrome_Autofill_Profiles else
  if Name = 'CHROMEBOOKMARKS'          then Result := Array_Items_Chrome_Bookmarks else
  if Name = 'CHROMECACHE'              then Result := Array_Items_Chrome_Cache else
  if Name = 'CHROMECOOKIES'            then Result := Array_Items_Chrome_Cookies else
  if Name = 'CHROMEDOWNLOADS'          then Result := Array_Items_Chrome_Downloads else
  if Name = 'CHROMEFAVICONS'           then Result := Array_Items_Chrome_Favicons else
  if Name = 'CHROMEHISTORY'            then Result := Array_Items_Chrome_History else
  if Name = 'CHROMEKEYWORDSEARCHTERMS' then Result := Array_Items_Chrome_Keyword_Search_Terms else
  if Name = 'CHROMELOGINS'             then Result := Array_Items_Chrome_Logins else
  if Name = 'CHROMESHORTCUTS'          then Result := Array_Items_Chrome_Shortcuts else
  if Name = 'CHROMETOPSITES'           then Result := Array_Items_Chrome_TopSites else
  if Name = 'CHROMESYNCDATA'           then Result := Array_Items_Chrome_SyncData else
